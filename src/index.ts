...
function withSecurityHeaders(response: Response): Response {
  ...
  headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://cdn.buymeacoffee.com; connect-src 'self'; frame-ancestors 'none'; base-uri 'none'; upgrade-insecure-requests"
  );
